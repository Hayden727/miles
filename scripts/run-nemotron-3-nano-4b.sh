#!/bin/bash
# Single-node (8x H200) 10-step RL smoke test for Nemotron-3-Nano-4B via AutoBridge.
# Parallelism cell is TP=2 (matches scripts/run-qwen3.5-4B.sh starting point).
# Dense architecture so EP is N/A. Subsequent cells (PP=2, CP=2, TP=4, TP=2xPP=2)
# swap the PERF_ARGS block.
